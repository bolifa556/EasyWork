...
export async function downloadVerified({ url, destination, sha256, integrity }) {
  ...
  if (await digest(destination, algorithm, encoding).catch(() => null) === expected) return destination;
